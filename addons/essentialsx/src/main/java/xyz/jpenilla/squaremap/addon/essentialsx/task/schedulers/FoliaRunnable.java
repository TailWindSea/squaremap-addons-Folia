package xyz.jpenilla.squaremap.addon.essentialsx.task.schedulers;
...
public abstract class FoliaRunnable implements Runnable {
    ...
    public FoliaRunnable(@Nullable AsyncScheduler scheduler, @Nullable TimeUnit timeUnit) {
        this.asyncScheduler = scheduler;
        this.timeUnit = timeUnit;
    }

    public FoliaRunnable(@Nullable EntityScheduler scheduler, @Nullable Runnable retired) {
        this.entityScheduler = scheduler;
        this.entityRetired = retired;
    }

    public FoliaRunnable(@Nullable GlobalRegionScheduler scheduler) {
        this.globalRegionScheduler = scheduler;
    }

    public FoliaRunnable(@Nullable RegionScheduler scheduler, @Nullable Location location) {
        this.regionScheduler = scheduler;
        this.location = location;
    }

    public FoliaRunnable(@Nullable RegionScheduler scheduler, @Nullable World world, int chunkX, int chunkZ) {
        this.regionScheduler = scheduler;
        this.world = world;
        this.chunkX = chunkX;
        this.chunkZ = chunkZ;
